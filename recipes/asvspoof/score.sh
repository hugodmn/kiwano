...
python utils/compute_cllr.py $t/processed/eval/trials.sort.v2 $t/processed/eval/score.txt
python utils/compute_auc.py $t/processed/eval/trials.sort.v2 $t/processed/eval/score.txt
